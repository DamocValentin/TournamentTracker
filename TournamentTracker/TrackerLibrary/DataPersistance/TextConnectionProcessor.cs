...
namespace TrackerLibrary.DataPersistance.TextHelper
{
    public static class TestConnectionProcessor
    {
        ...
        public static void SaveMatchupToFile( this MatchupModel matchup, string matchupFile, string matchupEntryFile)
        {
            ...
            foreach(MatchupModel m in matchups)
            {
                ...
                lines.Add($"{m.Id},{ConvertMatcupEntryListToString(m.Entries)},{winner},{m.MatchupRound}");
            }

            File.WriteAllLines(GlobalConfig.MatchupFile, lines);
        }
        ...
        private static string ConvertMatcupEntryListToString(List<MatchupEntryModel> entries)
        {
            string output = "";
        ...
        private static string ConvertRoundListToString(List<List<MatchupModel>> rounds)
        {
            ...
            foreach (List<MatchupModel> l in rounds)
            {
                output += $"{ConvertMatcupListToString(l)}|";
            }
        ...
        private static string ConvertMatcupListToString(List<MatchupModel> matchups)
        {
            string output = "";
